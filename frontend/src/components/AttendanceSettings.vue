...
import { useAttendanceSettings, useUpdateAttendanceSettings, type AttendanceSettings, type UpdateAttendanceSettingsData } from '@/composables/useAttendanceSettings'
